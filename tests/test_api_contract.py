...
class ApiContractTests(unittest.TestCase):
    def setUp(self):
        ...
        self.original_recognize = server.azure_speech.recognize
        ...
        server.azure_speech.recognize = lambda raw, expected="", mode="mock": {
    ...
    def tearDown(self):
        ...
        server.azure_speech.recognize = self.original_recognize
    ...
    def test_reply_has_structured_turn_contract(self):
        ...
        self.assertEqual(data["turn"]["task_action"], "pause_and_resume")
